const sneakers = [
  ...
  },
  {
    ...
    `,
    exhibitionNote: "Tác phẩm thuộc dòng sản phẩm lưu trữ đặc biệt từ quỹ Virgil Abloh Archive (VAA). Thay vì mang branding thương mại truyền thống, phiên bản này mang giá trị di sản nghệ thuật cao cấp, đánh dấu bước tiến tư duy thiết kế đương đại và là một trong những hiện vật có giá trị sưu tầm cốt lõi của bảo tàng số."
  }
];
