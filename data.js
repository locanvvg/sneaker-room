const sneakers = [
    ...
    story: {
      vi: `
        ...
        <div class="exhibition-note">
          <strong>Ghi chú lưu trữ (Exhibition Note):</strong> Tác phẩm thuộc phiên bản đặc biệt (F&F). Các phiên bản dạng này (như Promo Sample, Player Exclusive hoặc Friends & Family) chỉ được sản xuất giới hạn để dành riêng cho vận động viên, người thân hoặc nội bộ thương hiệu. Do không được phát hành thương mại tại các cửa hàng bán lẻ, tác phẩm không có giá niêm yết gốc (Retail Price: N/A) và sở hữu giá trị sưu tầm đặc biệt trên thị trường quốc tế.
        </div>
      `,
      en: `
        <p>While the commercial Air Jordan 1 'Black/Gym Red' 'Bloodline' released during Black Friday 2019 is familiar to global sneakerheads, this <b>Air Jordan 1 High OG 'Black Bloodline' PE (Player Exclusive)</b> rises to an entirely different tier. This was an ultra-limited, exclusive Christmas gift crafted by Jordan Brand in December 2019 specifically for brand ambassador athletes.</p>
        <p>The defining value of this PE line is its strict production of only 93 pairs worldwide, accompanied by personalized holiday greeting cards from Jordan Brand and custom-stamped box labels with each athlete's name. The sneaker features a premium black leather upper accented with sharp Gym Red piping along the cuts and classic Swoosh, set atop a clean white midsole and vibrant red outsole.</p>
        <p>However, the piece residing in Lộc An's personal collection carries even greater historical significance: rather than a standard commercial PE pair, this is an <b>official Sample prototype of this PE line</b>. Owning a prototype makes this size 7 US rarity an invaluable archival artifact within the Lộc An Sneaker Collection.</p>
        <div class="exhibition-note">
          <strong>Exhibition Note:</strong> This piece belongs to a special edition tier (F&F). Such versions (such as Promo Samples, Player Exclusives, or Friends & Family releases) are produced in strictly limited quantities exclusively for athletes, close associates, or brand insiders. As they are not commercially released at retail stores, these pieces carry no original retail price (Retail Price: N/A) and possess exceptional collector value on the global market.
        </div>
      `
    }
  },
  {
    ...
    story: {
      ...
      `,
      en: `
        <p>To celebrate Quai 54—the world's most prestigious streetball tournament held annually in Paris—Jordan Brand created two special Air Jordan 1 Retro High OG editions for the summer of 2017. While the traditional black colorway saw a general commercial release on July 8, 2017, for $160, this unique split colorway holds ultimate tier status: reserved exclusively for <b>Friends & Family (F&F)</b> guests.</p>
        <p>Featuring the original <i>Black/Italy Blue-Fast/University Red</i> color scheme, the breakthrough design highlight is the bold "Split Colorway" running down the upper. The right shoe blends vibrant Italy Blue with deep black, while the left creates a striking contrast with blazing University Red. The Quai 54 tournament logo is elegantly embroidered on the woven tongue and subtly debossed on the insoles.</p>
        <p>Much like the 2011 Quai 54 F&F Air Jordan 5s, this version never hit retail shelves globally. Strictly limited pairs were gifted directly to key athletes, artists, and culture influencers. Owning this <b>Deadstock</b> pair in rare size <b>12.5 US</b> stands as a pinnacle testament to passion and digital archiving within the Lộc An Sneaker Collection.</p>
        <div class="exhibition-note">
          <strong>Exhibition Note:</strong> This piece belongs to a special edition tier (F&F). Such versions (such as Promo Samples, Player Exclusives, or Friends & Family releases) are produced in strictly limited quantities exclusively for athletes, close associates, or brand insiders. As they are not commercially released at retail stores, these pieces carry no original retail price (Retail Price: N/A) and possess exceptional collector value on the global market.
        </div>
      `
  ...
  },
  {
    ...
    story: {
      ...
      `,
      en: `
        <p>Following the massive success of their 2023 collaboration, global skateboarding icon and Olympic Gold medalist Yuto Horigome teamed up with Nike SB again to drop the <b>Nike SB Dunk Low Yuto Horigome 'Matcha'</b> on April 5, 2025. While the first release embraced minimalist urban tones, the 'Matcha' edition immerses viewers in serene nature via refined shades of traditional Japanese green tea.</p>
        <p>The shoe features a symphony of earthy, luxurious tones: a <i>Light Khaki</i> base, <i>Asparagus</i> suede overlays, deep <i>Legion Green</i> accents, and subtle <i>Burnt Sienna</i> highlights. Yuto's signature crossed feather crest is debossed on the lateral heel, paired with performance cushioning built for elite skaters.</p>
        <p>Globally, this model launched as a premium General Release for $135. However, Lộc An's archived piece transcends standard commercial specs: the upper bears the <b>direct hand signature of Yuto Horigome himself</b>. This blend of contemporary design and live signature turns this size <b>12 US</b> masterpiece into an invaluable archival treasure.</p>
      `
    }
  },
  {
    ...
    title: {
      vi: "Virgil Abloh Archive x Air Jordan 1 Retro High OG SP 'Alaska'",
      en: "Virgil Abloh Archive x Air Jordan 1 Retro High OG SP 'Alaska'"
    },
    subtitle: {
    ...
    story: {
      ...
      `,
      en: `
        <p>Embodying the visionary design legacy of the late Virgil Abloh, the <b>Virgil Abloh Archive x Air Jordan 1 Retro High OG SP 'Alaska'</b> launched on April 3, 2026. This historic release re-imagines the legendary "White" colorway (Euro Exclusive) that shook the globe during "The Ten" collection.</p>
        <p>Unlike standard Off-White commercial collabs, this edition is directly certified by the <b>Virgil Abloh Archive (VAA)</b>, featuring exclusive <i>"V.A.A. for NIKE"</i> lateral text. The name 'Alaska' honors pristine glacial whites while subtly nodding to Virgil's <i>Alaska Alaska</i> design studio.</p>
        <p>The shoe retains classic deconstructed features including premium white leathers, exposed ice-blue mesh, and signature zip ties. Complete with custom die-cut packaging and a sketching notebook bearing <i>"MODERNISM IS NOT NEW"</i>, this size <b>10 US</b> piece honors timeless artistry within the Lộc An Sneaker Collection.</p>
      `
    }
  }
];
