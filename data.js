const sneakers = [
  ...
  ===================================================== */
  {
    ...
    subtitle: {
      vi: "Friends & Family Sample (2019)",
      en: "Friends & Family Sample (2019)"
    },
    ...
    story: {
      vi: `
        <p><b>Jordan 1 Retro High OG 'Black Bloodline' PE Sample</b> thuộc một nhánh đặc biệt của Bloodline 2019, được phát triển ngoài hệ thống phát hành bán lẻ thông thường. Phiên bản Black Bloodline sử dụng nền da đen với các đường nhấn Gym Red, tạo nên cách diễn giải tối và mạnh hơn so với bản Bloodline thương mại.</p>
        <p>Chương trình PE được Jordan Brand chuẩn bị cho các vận động viên và những cá nhân thuộc mạng lưới của thương hiệu. Các đôi hoàn thiện trong chương trình mang provenance riêng, trong khi hiện vật được lưu giữ tại Lộc An Sneaker Collection còn đặc biệt hơn vì đây là <b>sample của chính dòng PE</b>, ghi lại một giai đoạn phát triển trước hoặc song song với các đôi hoàn thiện.</p>
        <p>Giá trị của hiện vật vì thế nằm ở sự giao nhau giữa Air Jordan 1, Player Exclusive và pre-production sample — một cấu hình vốn không được thiết kế cho thị trường bán lẻ đại trà.</p>
      `,
      en: `
        <p>The <b>Jordan 1 Retro High OG 'Black Bloodline' PE Sample</b> belongs to a special branch of the 2019 Bloodline project developed outside conventional retail distribution. Its predominantly black leather upper and Gym Red accents create a darker interpretation than the commercial Bloodline release.</p>
        <p>The PE program was prepared by Jordan Brand for athletes and individuals within the brand's network. While completed PE pairs carried recipient-specific provenance, the artifact preserved in the Lộc An Sneaker Collection is even more unusual: it is a <b>sample from the PE program itself</b>, documenting a development stage surrounding the completed run.</p>
        <p>Its significance therefore lies at the intersection of the Air Jordan 1, Player Exclusive footwear, and pre-production sampling.</p>
      `
    }
  },
  ...
  ===================================================== */
  {
    ...
    subtitle: {
      vi: "Friends & Family Exclusive (2017)",
      en: "Friends & Family Exclusive (2017)"
    },
    ...
    story: {
      vi: `
        <p><b>Jordan 1 Retro High OG 'Quai 54' F&amp;F</b> được tạo ra trong bối cảnh Quai 54, giải streetball thường niên tại Paris và một trong những mối liên hệ lâu dài nhất giữa Jordan Brand với văn hóa bóng rổ đường phố châu Âu.</p>
        <p>Điểm nhận diện mạnh nhất của phiên bản Friends &amp; Family 2017 là cấu trúc <b>mismatched / split color blocking</b>: một chiếc kết hợp Italy Blue với đen, chiếc còn lại sử dụng University Red với đen. Hai gam màu tạo liên tưởng đến nước Pháp nhưng được thể hiện theo cách bất đối xứng thay vì một bố cục tricolor trực tiếp.</p>
        <p>Quai 54 branding và cấu trúc vật liệu khác nhau giữa hai chiếc khiến đôi giày trở thành một trong những phiên bản Air Jordan 1 gắn với giải đấu Paris dễ nhận diện nhất.</p>
      `,
      en: `
        <p>The <b>Jordan 1 Retro High OG 'Quai 54' F&amp;F</b> was created around Quai 54, the annual Paris streetball tournament and one of Jordan Brand's longest-running connections with European basketball culture.</p>
        <p>Its defining feature is the <b>mismatched split color blocking</b>: one shoe combines Italy Blue with black, while the other uses University Red with black. The colors reference France without relying on a conventional tricolor treatment.</p>
        <p>Quai 54 branding and the asymmetric material treatment give the 2017 Friends &amp; Family edition a distinctive identity within the Air Jordan 1 archive.</p>
      `
    }
  },
  ...
  ===================================================== */
  {
    ...
    title: {
      vi: "Nike SB Dunk Low Yuto Horigome 'Matcha'",
      en: "Nike SB Dunk Low Yuto Horigome 'Matcha'"
    },
    subtitle: {
      vi: "Signature Skateboarding Edition (2025)",
      en: "Signature Skateboarding Edition (2025)"
    },
    sku: "HF8022-300",
    ...
    story: {
      vi: `
        <p><b>Nike SB Dunk Low Yuto Horigome 'Matcha'</b> tiếp nối màn hợp tác giữa Nike SB và nhà vô địch Olympic Yuto Horigome. Bảng màu lấy cảm hứng từ matcha Nhật Bản, phối Light Khaki, Asparagus, Legion Green và Burnt Sienna trên nền vật liệu mang tính skate.</p>
        <p>Biểu tượng lông vũ gắn với gia đình Yuto xuất hiện ở gót, kết nối đôi giày với di sản cá nhân và nguồn gốc Nhật Bản của vận động viên. Cấu trúc vẫn giữ đệm và tỷ lệ đặc trưng của SB Dunk dành cho skateboarding.</p>
        <p>Hiện vật trong Lộc An Sneaker Collection có thêm provenance đặc biệt nhờ <b>chữ ký trực tiếp của Yuto Horigome</b>, tạo ra một liên kết vật lý với chính vận động viên đứng sau thiết kế.</p>
      `,
      en: `
        <p>The <b>Nike SB Dunk Low Yuto Horigome 'Matcha'</b> continues Nike SB's collaboration with Olympic champion Yuto Horigome. Its palette draws from Japanese matcha, combining Light Khaki, Asparagus, Legion Green, and Burnt Sienna across a skate-oriented construction.</p>
        <p>Yuto's feather family crest appears at the heel, connecting the design to his personal heritage and Japanese identity while the silhouette retains the padded, performance-oriented character of the SB Dunk.</p>
        <p>The artifact preserved in the Lộc An Sneaker Collection carries additional provenance through <b>Yuto Horigome's direct signature</b>.</p>
      `
    }
  },
  ...
  ===================================================== */
  {
    ...
    subtitle: {
      vi: "Archive Heritage Edition (2026)",
      en: "Archive Heritage Edition (2026)"
    },
    sku: "AA3834-100",
    ...
    story: {
      vi: `
        <p><b>Jordan 1 Retro High OG x Virgil Abloh Archive 'Alaska'</b> đưa ngôn ngữ deconstructed gắn liền với Virgil Abloh trở lại trên nền Air Jordan 1 trắng. Các lớp vật liệu lộ thiên, mesh và typography giữ cảm giác prototype vốn là dấu ấn của thiết kế Off-White.</p>
        <p>Tên gọi 'Alaska' gợi bảng màu trắng lạnh đồng thời liên hệ với studio sáng tạo Alaska Alaska. Phiên bản archive điều chỉnh typography để nhấn mạnh vai trò lưu trữ và di sản thiết kế của Virgil Abloh.</p>
        <p>Light-blue zip tie trở thành một điểm màu dễ nhận biết giữa bố cục gần như hoàn toàn trắng, tạo sự cân bằng giữa tính lưu trữ và ngôn ngữ thiết kế nguyên bản.</p>
      `,
      en: `
        <p>The <b>Jordan 1 Retro High OG x Virgil Abloh Archive 'Alaska'</b> revisits the deconstructed language associated with Virgil Abloh through an almost entirely white Air Jordan 1. Exposed layers, mesh, and industrial typography preserve the prototype-like character of his work.</p>
        <p>The 'Alaska' name evokes the cold white palette while also referencing the Alaska Alaska creative studio. Archive-specific typography shifts the emphasis toward preserving and recontextualizing Abloh's design legacy.</p>
        <p>A light-blue zip tie provides one of the most recognizable visual accents within the otherwise restrained composition.</p>
      `
    }
  },
  ...
  ===================================================== */
  {
    ...
    subtitle: {
      vi: "Pre-Release Sample Edition (2026)",
    ...
    story: {
      vi: `
        <p><b>Jordan 1 Retro High OG x Fragment x Union LA 'Varsity Red/Sport Royal'</b> kết hợp ngôn ngữ tinh giản của Fragment với cách tái cấu trúc vintage đặc trưng của Union Los Angeles.</p>
        <p>Cấu trúc Black Toe được ghép với Sport Royal ở gót và Varsity Red ở cổ giày, tạo cảm giác như nhiều Air Jordan 1 cổ điển đã được cắt và lắp lại. Exposed stitching và nhãn UN/LA làm rõ cách tiếp cận thủ công của Union.</p>
        <p>Hiện vật trong collection là <b>sample</b> thuộc giai đoạn phát triển trước phát hành, vì vậy giá trị lưu trữ nằm ở provenance của một sản phẩm tiền thương mại thay vì ở một đôi retail thông thường.</p>
      `,
      en: `
        <p>The <b>Jordan 1 Retro High OG x Fragment x Union LA 'Varsity Red/Sport Royal'</b> combines Fragment's restrained graphic language with Union Los Angeles' reconstructed vintage aesthetic.</p>
        <p>A Black Toe foundation is joined by Sport Royal at the heel and Varsity Red around the collar, creating the impression of multiple vintage Air Jordan 1s being cut and recombined. Exposed stitching and UN/LA branding reinforce Union's handcrafted approach.</p>
        <p>The artifact preserved in the collection is a <b>sample</b> associated with the pre-release development stage rather than a conventional retail pair.</p>
      `
    }
  },

  /* =====================================================
     6. JORDAN 1 HIGH RETRO OG SHADOW 2009
  ===================================================== */
  {
    ...
    story: {
      vi: `
        <p><b>Jordan 1 High Retro OG 'Shadow' 2009</b> đánh dấu lần trở lại đầu tiên của Shadow sau phiên bản nguyên bản năm 1985. Black và Shadow Grey tạo nên một hệ màu trung tính, ít phụ thuộc vào tương phản mạnh như Chicago, Bred hay Royal.</p>
        <p>Sự tiết chế giúp Shadow có tuổi thọ thị giác đặc biệt. Thiết kế để cấu trúc Jordan 1, Swoosh và Wings logo trở thành tâm điểm thay vì dựa vào một câu chuyện màu sắc quá lớn.</p>
        <p>Bản 2009 cũng ghi lại một giai đoạn chuyển tiếp trong lịch sử Jordan retro, khi Jumpman branding vẫn xuất hiện ở những vị trí mà các bản OG-accurate hiện đại thường sử dụng Nike Air.</p>
      `,
      en: `
        <p>The <b>Jordan 1 High Retro OG 'Shadow' 2009</b> marked the first return of Shadow after the original 1985 edition. Black and Shadow Grey create a neutral color system that relies less on high contrast than Chicago, Bred, or Royal.</p>
        <p>That restraint gives Shadow unusual visual longevity and allows the architecture of the Jordan 1, its Swoosh, and Wings logo to remain the focus.</p>
        <p>The 2009 edition also documents a transitional period in Jordan retro history, when Jumpman branding remained visible in areas later retros would return to Nike Air.</p>
      `
    }
  },

  /* =====================================================
     7. BAPE x STUSSY CAMO CANVAS HI TOP
  ===================================================== */
  {
    ...
    story: {
      vi: `
        <p><b>BAPE x Stüssy Camo Canvas Hi Top 'Green Camo'</b> thuộc dự án <b>Survival of the Fittest</b> trong mùa Holiday 2010, gắn với dịp kỷ niệm 30 năm Stüssy.</p>
        <p>Màn hợp tác kết nối hai dòng chảy quan trọng của streetwear: văn hóa surf/street California của Stüssy và Harajuku streetwear của A Bathing Ape. Green camouflage trở thành bề mặt chung để graphic của cả hai thương hiệu cùng xuất hiện.</p>
        <p>Phom high-top đơn giản, toe cap cao su trắng và foxing stripe đen giúp camouflage trở thành yếu tố thị giác chính thay vì cạnh tranh với quá nhiều panel hoặc branding cỡ lớn.</p>
      `,
      en: `
        <p>The <b>BAPE x Stüssy Camo Canvas Hi Top 'Green Camo'</b> belongs to the <b>Survival of the Fittest</b> project from Holiday 2010, connected to Stüssy's 30th anniversary.</p>
        <p>The collaboration joined two major streetwear lineages: Stüssy's California surf and street culture and A Bathing Ape's Harajuku identity. Green camouflage becomes a shared surface carrying graphics from both brands.</p>
        <p>The simple high-top construction, white rubber toe cap, and black foxing stripe allow the camouflage treatment to remain the dominant visual element.</p>
      `
    }
  },

  /* =====================================================
     8. NIKE x OFF-WHITE WAFFLE RACER SP WHITE
  ===================================================== */
  {
    ...
    story: {
      vi: `
        <p><b>Nike x Off-White Waffle Racer SP 'White'</b> thuộc dự án <b>Athlete in Progress</b>, giai đoạn Virgil Abloh chuyển sự chú ý từ việc tái cấu trúc sneaker icons sang running, track &amp; field và hình ảnh vận động viên đang không ngừng phát triển.</p>
        <p>Di sản Waffle Racer của Nike được phủ bằng translucent film, mesh, dual-lacing và Electric Green cord, khiến phần upper mang cảm giác của một prototype đang thử nghiệm. Các rubber spikes lớn ở outsole đẩy silhouette tới khoảng giao giữa retro runner, track spike và trail footwear.</p>
        <p>Industrial typography, orange tab và zip-tie language giữ lại các mã thiết kế quen thuộc của Off-White, trong khi dấu vết yellowing hiện tại trở thành một phần của lịch sử vật lý của hiện vật.</p>
      `,
      en: `
        <p>The <b>Nike x Off-White Waffle Racer SP 'White'</b> belongs to <b>Athlete in Progress</b>, a period when Virgil Abloh shifted attention from reconstructing sneaker icons toward running, track and field, and the athlete as an evolving figure.</p>
        <p>Nike's Waffle Racer heritage is covered with translucent film, mesh, dual lacing, and an Electric Green cord, giving the upper a prototype-like appearance. Pronounced rubber spikes move the silhouette between retro running, track spikes, and trail footwear.</p>
        <p>Industrial typography, the orange tab, and zip-tie language preserve familiar Off-White codes, while the pair's yellowing records its physical aging over time.</p>
      `
    }
  },

  /* =====================================================
     9. PUMA x ROSÉ SPEEDCAT LEATHER WARM WHITE
  ===================================================== */
  {
    ...
    story: {
      vi: `
        <p><b>PUMA x ROSÉ Speedcat Leather 'Warm White'</b> thuộc collection đầy đủ đầu tiên của ROSÉ cùng PUMA, phát triển như một sự phản ánh phong cách cá nhân của nghệ sĩ thay vì chỉ đặt tên lên một phối màu có sẵn.</p>
        <p>Speedcat bắt nguồn từ motorsport với phom thấp, streamlined và gần mặt đất. Trong cách diễn giải của ROSÉ, cấu trúc racing được đưa vào một ngôn ngữ mềm mại hơn thông qua vật liệu, tỷ lệ và hệ dây phụ wraparound.</p>
        <p>Sự tương phản giữa di sản tốc độ và tinh thần thời trang tinh tế thể hiện ý tưởng <b>quiet rebellion</b>: khác biệt rõ ràng nhưng không dựa vào branding quá lớn.</p>
      `,
      en: `
        <p>The <b>PUMA x ROSÉ Speedcat Leather 'Warm White'</b> belongs to ROSÉ's first full collection with PUMA, developed as a reflection of her personal style rather than simply placing an artist's name on an existing colorway.</p>
        <p>The Speedcat originates in motorsport through a low, streamlined, close-to-the-ground form. ROSÉ's interpretation softens that racing foundation through materials, proportions, and a secondary wraparound lacing system.</p>
        <p>The contrast between speed heritage and refined fashion language expresses the project's idea of <b>quiet rebellion</b>: visibly different without relying on oversized branding.</p>
      `
    }
  },

  /* =====================================================
     10. JORDAN 4 RETRO BLACK CEMENT 1999
  ===================================================== */
  {
    id: "jordan-4-black-cement-1999",
    title: {
      vi: "Jordan 4 Retro 'Black Cement' 1999",
      en: "Jordan 4 Retro 'Black Cement' 1999"
    },
    subtitle: {
      vi: "First Black Cement Retro Release (1999)",
      en: "First Black Cement Retro Release (1999)"
    },
    sku: "136013-001",
    ...
    story: {
      vi: `
        <p><b>Jordan 4 Retro 'Black Cement' 1999</b> là lần retro đầu tiên của Black Cement sau phiên bản nguyên bản năm 1989, xuất hiện đúng một thập kỷ sau thiết kế ban đầu của Tinker Hatfield.</p>
        <p>Air Jordan 4 đưa mesh paneling, plastic support wings và visible Air vào một cấu trúc kỹ thuật hơn, đồng thời gắn chặt với lịch sử thi đấu của Michael Jordan, đặc biệt là khoảnh khắc "The Shot" năm 1989.</p>
        <p>Bản 1999 được đánh giá cao vì giữ <b>Nike Air</b> ở gót và vì vị trí của nó như một trong những retro đầu tiên tái giới thiệu màu OG cho thế hệ sưu tầm mới.</p>
      `,
      en: `
        <p>The <b>Jordan 4 Retro 'Black Cement' 1999</b> was the first retro of Black Cement after the original 1989 release, arriving exactly a decade after Tinker Hatfield's original design.</p>
        <p>The Air Jordan 4 introduced mesh paneling, plastic support wings, and visible Air within a more technical construction, while becoming closely linked to Michael Jordan's on-court history, especially "The Shot" in 1989.</p>
        <p>The 1999 edition remains notable for retaining <b>Nike Air</b> heel branding and for its position as an early retro that reintroduced an original colorway to a new generation of collectors.</p>
      `
    }
  },

  /* =====================================================
     11. NEW BALANCE 2002R PERSONAL CUSTOM
  ===================================================== */
  {
    id: "new-balance-2002r-custom",
    title: { vi: "New Balance 2002R", en: "New Balance 2002R" },
    subtitle: { vi: "Personal Custom 1/1", en: "Personal Custom 1/1" },
    sku: "N/A",
    colorway: "N/A",
    retailPrice: "$145 USD",
    releaseDate: "N/A",
    ...
    story: {
      vi: `
        <p><b>New Balance 2002R</b> là một trong những silhouette tiêu biểu của làn sóng phục hưng technical running footwear. Upper nhiều lớp và nền đế kết hợp ABZORB, N-ergy cùng Stability Web giúp mẫu giày duy trì cảm giác retro-runner nhưng vẫn phù hợp cho sử dụng hằng ngày.</p>
        <p>Hiện vật trong Lộc An Sneaker Collection được chủ sở hữu tự custom thành một <b>personal 1-of-1</b>, lấy cảm hứng từ ngôn ngữ hội họa của Jackson Pollock. Các lớp sơn đen, trắng, đỏ và xám đi xuyên qua nhiều panel thay vì bị giới hạn trong từng vùng vật liệu.</p>
        <p>Đây là một tác phẩm custom cá nhân, không phải collaboration chính thức giữa New Balance và Jackson Pollock hoặc Pollock-Krasner Foundation.</p>
      `,
      en: `
        <p>The <b>New Balance 2002R</b> is a defining silhouette in the revival of technical running footwear. Its layered upper and sole platform combining ABZORB, N-ergy, and Stability Web preserve a retro-runner identity while remaining practical for everyday wear.</p>
        <p>The artifact in the Lộc An Sneaker Collection was personally customized into a <b>1-of-1</b>, inspired by the visual language associated with Jackson Pollock. Black, white, red, and grey paint move across multiple panels rather than remaining confined to individual materials.</p>
        <p>This is a personal custom and not an official collaboration between New Balance and Jackson Pollock or the Pollock-Krasner Foundation.</p>
      `
    }
  },

  /* =====================================================
     12. BALENCIAGA DEFENDER BEIGE
  ===================================================== */
  {
    id: "balenciaga-defender-beige",
    title: { vi: "Balenciaga Defender 'Beige'", en: "Balenciaga Defender 'Beige'" },
    subtitle: { vi: "Tire-Tread Runner (2022)", en: "Tire-Tread Runner (2022)" },
    sku: "685613W2RA69700",
    colorway: "Beige",
    ...
    story: {
      vi: `
        <p><b>Balenciaga Defender</b> xuất hiện trong giai đoạn Demna liên tục thử nghiệm với tỷ lệ và trọng lượng thị giác của sneaker. Sau Triple S và Track, Defender tiếp tục biến footwear thành một vật thể gần với điêu khắc.</p>
        <p>Điểm nhận diện lớn nhất là outsole lấy cảm hứng từ <b>tire tread</b>, với các khối cao su lớn bao quanh upper và làm thay đổi hoàn toàn tỷ lệ bàn chân. Worn-out effect được đưa vào thiết kế ngay từ đầu, khiến dấu hiệu bụi và hao mòn trở thành một phần của aesthetic.</p>
        <p>Colorway Beige làm rõ ý tưởng này bằng các sắc cream, off-white và beige, trong khi branding tương đối tiết chế để hình dáng và kiến trúc phần đế trở thành yếu tố chính.</p>
      `,
      en: `
        <p>The <b>Balenciaga Defender</b> emerged during a period when Demna repeatedly experimented with sneaker proportion and visual weight. Following models such as the Triple S and Track, the Defender pushes footwear toward the territory of sculptural object.</p>
        <p>Its defining feature is a <b>tire-tread</b>-inspired outsole, with oversized rubber blocks wrapping around the upper and radically changing the foot's proportions. A deliberate worn-out effect incorporates signs of dust and abrasion into the design from the beginning.</p>
        <p>The Beige colorway reinforces that concept through cream, off-white, and beige tones, while restrained branding allows shape and tread architecture to define the shoe.</p>
      `
    }
  },

  /* =====================================================
     13. JORDAN 1 RETRO HIGH OG CITY OF FLIGHT
  ===================================================== */
  {
    ...
    story: {
      vi: `
        <p><b>Jordan 1 Retro High OG 'City of Flight'</b> được xây dựng quanh mối liên hệ giữa Air Jordan, Los Angeles và văn hóa NBA All-Star trong giai đoạn thành phố đăng cai All-Star Weekend 2018.</p>
        <p>Black leather kết hợp Metallic Gold tạo một diện mạo trang trọng, trong khi Summit White giúp cân bằng bố cục. Một trong những chi tiết kể chuyện quan trọng nằm bên trong giày: sockliner mang graphic <b>bản đồ Los Angeles</b>.</p>
        <p>Chi tiết địa lý này khiến City of Flight không chỉ là một Jordan 1 đen-vàng mà trở thành một phiên bản gắn với một thành phố và một thời điểm cụ thể trong văn hóa bóng rổ.</p>
      `,
      en: `
        <p>The <b>Jordan 1 Retro High OG 'City of Flight'</b> was built around the relationship between Air Jordan, Los Angeles, and NBA All-Star culture as the city prepared to host All-Star Weekend in 2018.</p>
        <p>Black leather and Metallic Gold create a formal palette, balanced by Summit White. One of the most important narrative details appears inside the shoe, where the sockliner carries a graphic <b>map of Los Angeles</b>.</p>
        <p>That geographic detail turns City of Flight from a simple black-and-gold Jordan 1 into a sneaker tied to a specific city and moment in basketball culture.</p>
      `
    }
  },

  /* =====================================================
     14. JORDAN 1 LOW REVERSE BRED
  ===================================================== */
  {
    id: "jordan-1-low-reverse-bred-2020",
    title: { vi: "Jordan 1 Low 'Reverse Bred'", en: "Jordan 1 Low 'Reverse Bred'" },
    subtitle: {
    ...
    story: {
      vi: `
        <p><b>Jordan 1 Low 'Reverse Bred'</b> lấy một trong những hệ màu nổi tiếng nhất của Air Jordan rồi tái sắp xếp color blocking trên phom low-top.</p>
        <p>Black xuất hiện ở toe box và mid-panel, trong khi Gym Red bao phủ overlays và Swoosh. Cách phân bố này giữ liên hệ trực tiếp với ngôn ngữ Bred nhưng tạo ra một bố cục sáng và dễ sử dụng hằng ngày hơn.</p>
        <p>Phiên bản thể hiện cách Jordan Brand có thể tái sử dụng một visual code lịch sử mà không cần sao chép nguyên cấu trúc của bản high-top kinh điển.</p>
      `,
      en: `
        <p>The <b>Jordan 1 Low 'Reverse Bred'</b> takes one of the most recognizable color languages in Air Jordan history and rearranges its blocking on a low-top structure.</p>
        <p>Black appears across the toe box and mid-panel while Gym Red covers the overlays and Swoosh. The distribution maintains a direct connection to Bred while producing a brighter, more everyday-oriented composition.</p>
        <p>The model demonstrates how Jordan Brand can reuse a historic visual code without simply reproducing the classic high-top arrangement.</p>
      `
    }
  },

  /* =====================================================
     15. VANS KNU SKOOL BLACK / TRUE WHITE
  ===================================================== */
  {
    id: "vans-knu-skool-black-true-white-rope-lace",
    title: { vi: "Vans Knu Skool 'Black/True White'", en: "Vans Knu Skool 'Black/True White'" },
    subtitle: { vi: "Chunky Skate Silhouette (2023)", en: "Chunky Skate Silhouette (2023)" },
    sku: "VN0009QC6BT",
    ...
    story: {
      vi: `
        <p><b>Vans Knu Skool</b> bắt nguồn từ ngôn ngữ skate footwear cuối thập niên 1990, thời kỳ sneaker trở nên dày, đệm lớn và cường điệu hơn đáng kể so với các model skate cổ điển.</p>
        <p>Oversized tongue, padded collar, thick laces và Sidestripe ba chiều tạo nên phom có volume lớn hơn Old Skool truyền thống, trong khi kết cấu vulcanized và waffle outsole vẫn giữ liên hệ trực tiếp với di sản skate của Vans.</p>
        <p>Đôi trong collection sử dụng rope laces như một modification cá nhân. Đây không phải factory edition hoặc collaboration chính thức của Vans.</p>
      `,
      en: `
        <p>The <b>Vans Knu Skool</b> originates from the visual language of late-1990s skate footwear, a period when sneakers became thicker, more padded, and more exaggerated than earlier skate models.</p>
        <p>An oversized tongue, padded collar, thick laces, and three-dimensional Sidestripe create much more volume than a traditional Old Skool, while vulcanized construction and the waffle outsole preserve a direct connection to Vans' skate heritage.</p>
        <p>The pair in the collection uses rope laces as a personal modification. This is not a factory edition or an official Vans collaboration.</p>
      `
    }
  },

  /* =====================================================
     16. JORDAN 13 RETRO DMP / FINALS PACK
  ===================================================== */
  {
    id: "jordan-13-retro-dmp-finals-pack-2017",

    title: {
      vi: "Jordan 13 Retro DMP 'Finals Pack'",
      en: "Jordan 13 Retro DMP 'Finals Pack'"
    },

    subtitle: {
      vi: "Defining Moments Pack / Finals Pack (2017)",
      en: "Defining Moments Pack / Finals Pack (2017)"
    },

    sku: "414571-135",

    colorway: "White/Metallic Gold/Black-Varsity Red",

    retailPrice: "$500 USD (Air Jordan 13/14 DMP Pack)",
    ...
    story: {
      vi: `
        <p><b>Khoảnh khắc cuối cùng của một triều đại.</b></p>

        <p>
          Air Jordan 13 DMP thuộc <b>Defining Moments Pack</b>, bộ phát hành được Jordan Brand tạo ra để kỷ niệm chức vô địch NBA thứ sáu và cũng là chức vô địch cuối cùng của Michael Jordan cùng Chicago Bulls vào năm 1998. Bộ đôi gồm Air Jordan 13 và Air Jordan 14, hai silhouette gắn liền với chặng kết của mùa giải huyền thoại ấy, đồng thời sử dụng các chi tiết vàng kim như một biểu tượng của chiến thắng.
        </p>

        <p>
          Trên Air Jordan 13, phần upper da trắng được kết hợp với những mảng Metallic Gold bao quanh thân dưới và gót giày, tạo nên một phiên bản sang trọng và giàu tính kỷ niệm hơn so với các phối màu Jordan 13 thông thường. Jumpman đỏ trên lưỡi giày vẫn giữ lại kết nối với màu sắc quen thuộc của Chicago Bulls, trong khi hologram đặc trưng của dòng Jordan 13 được xử lý theo hướng riêng cho phiên bản DMP.
        </p>

        <p>
          Điểm đáng chú ý nhất nằm ở phần hologram và thông điệp kể chuyện của đôi giày. Hologram sử dụng <b>“98”</b> cùng hình ảnh Michael Jordan gợi lại mùa giải vô địch cuối cùng, còn dòng chữ chia đôi giữa hai lưỡi giày — <b>“THEY CAN’T WIN”</b> và <b>“UNTIL WE QUIT”</b> — khiến đôi này trở thành một thiết kế mang tính biểu tượng, không chỉ đẹp về hình thức mà còn đậm dấu ấn lịch sử.
        </p>

        <p>
          Trong Lộc An Sneaker Collection, đây là một đôi đại diện rất rõ cho giai đoạn cuối của triều đại Michael Jordan tại Chicago: sang trọng, giàu biểu tượng và gắn trực tiếp với một trong những chương quan trọng nhất của lịch sử Air Jordan.
        </p>
      `,

      en: `
        <p><b>The final moment of a dynasty.</b></p>

        <p>
          The Air Jordan 13 DMP is part of Jordan Brand’s <b>Defining Moments Pack</b>, a release created to commemorate Michael Jordan’s sixth and final NBA championship with the Chicago Bulls in 1998. The pack paired the Air Jordan 13 with the Air Jordan 14, two silhouettes closely associated with the final chapter of that legendary title run, while Metallic Gold detailing served as a visual symbol of victory.
        </p>

        <p>
          On the Air Jordan 13, a white leather upper is combined with Metallic Gold panels wrapping the lower section and heel, giving the pair a more celebratory and luxurious character than most standard Jordan 13 colorways. The red Jumpman on the tongue preserves a subtle link to the familiar Chicago Bulls palette, while the model’s signature hologram receives a distinctive treatment unique to the DMP edition.
        </p>

        <p>
          The most memorable detail is the storytelling built into the shoe. The hologram incorporates <b>“98”</b> and imagery of Michael Jordan referencing the final championship season, while the split phrase inside the tongues — <b>“THEY CAN’T WIN”</b> and <b>“UNTIL WE QUIT”</b> — turns the pair into more than just a white-and-gold retro. It becomes a commemorative piece tied directly to one of the defining moments of Michael Jordan’s career.
        </p>

        <p>
          Within the Lộc An Sneaker Collection, this pair stands as a strong representation of the closing chapter of Jordan’s Chicago dynasty: elegant, symbolic, and deeply connected to one of the most important eras in Air Jordan history.
        </p>
      `
    }
  },
